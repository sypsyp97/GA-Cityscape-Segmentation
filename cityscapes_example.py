...
] = "3"  # Sets the TensorFlow C++ minimum log level to ERROR
os.environ[
    "PYTHONHASHSEED"
] = "1234"  # Set PYTHONHASHSEED to enable deterministic behavior
...
if __name__ == "__main__":
    ...
    )  # Print the training, validation, and test datasets
